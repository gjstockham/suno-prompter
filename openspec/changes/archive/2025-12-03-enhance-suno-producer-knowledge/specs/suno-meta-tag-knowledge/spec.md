# Spec: Suno Meta-Tag Knowledge

## Overview

Defines the meta-tag knowledge that the Suno Producer Agent must possess to generate optimal Suno-compatible outputs.
